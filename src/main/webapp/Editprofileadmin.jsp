...
<html>
   <head>
    ...
    <body style="background-color:#0A4141; overflow: hidden;">
        ...
        <form action="<%= request.getContextPath() %>/Editprofileadminservletfinal" class="was-validated" style="border-radius:10px; background-color:#fafafa;margin-left: 35%; margin-right:35%; margin-bottom:10px;" method="post">
                <div class="container">
