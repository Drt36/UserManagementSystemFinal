    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
             ...
             if(!newpassword.equals(confirmnewpassword) && status==false){
                String message11="New password and Confirm New password did not matched!!! Old password is also Wrong!!!";
                request.setAttribute("message11", message11);
                RequestDispatcher dispatcher = request.getRequestDispatcher("changePassworduser.jsp");
             ...
             if(newpassword.equals(confirmnewpassword)){
                ...
                dispatcher.forward(request, response);
                    ...
                    Logger.getLogger(ChangePasswordServletuser.class.getName()).log(Level.SEVERE, null, ex);
          }
    }
