 ...
 */
@WebServlet(name = "Editprofileadminservletfinal", urlPatterns = {"/Editprofileadminservletfinal"})
public class Editprofileadminservletfinal extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Editprofileadminservletfinal.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            sh.storeHistory(sescon,"Update details of "+first_name,datetime);
            
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Editprofileadminservletfinal.class.getName()).log(Level.SEVERE, null, ex);
        }
        
         String messg2 = "User details of selected user is Updated Successfully!!!";
