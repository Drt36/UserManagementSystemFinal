 ...
 */
@WebServlet("/Editprofileuserservletfinal")
public class Editprofileuserservletfinal extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Editprofileuserservletfinal.class.getName()).log(Level.SEVERE, null, ex);
        }
