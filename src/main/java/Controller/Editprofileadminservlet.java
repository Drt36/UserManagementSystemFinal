 ...
 */
@WebServlet(name = "Editprofileadminservlet", urlPatterns = {"/Editprofileadminservlet"})
public class Editprofileadminservlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Editprofileadminservlet.class.getName()).log(Level.SEVERE, null, ex);
        }
        
       
         request.setAttribute("user",user);
        RequestDispatcher dispatcher = request.getRequestDispatcher("Editprofileadmin.jsp");
