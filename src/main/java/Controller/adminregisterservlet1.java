...
public class adminregisterservlet1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
          ...
          try {
              ...
              Logger.getLogger(adminregisterservlet1.class.getName()).log(Level.SEVERE, null, ex);
          }
             ...
             try {
                    ...
                    String sescon = (String)session.getAttribute("user");
                        ...
                        sh.storeHistory(sescon,"Added new user named as:"+first_name,datetime);
                     ...
                     String message33 = "New user added Successfully.";
                              request.setAttribute("message33", message33);
               ...
               String message3 = "Email Already Exist.Try Another Email !!!";
