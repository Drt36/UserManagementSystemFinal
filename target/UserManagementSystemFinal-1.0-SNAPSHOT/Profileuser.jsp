...
<body>
 <body style="background-color:whitesmoke">
    ...
    <div class="sidebar">
      ...
      <a href="Profileuser.jsp" class="active">
...
<div class="card">
  ...
  <br>
        ...
        <button onclick="location.href='Editprofileuserservlet?username=<%=user.getUsername()%>'"  style="float:left; margin-left:45%;" class="btn warning"/>Edit</button>
